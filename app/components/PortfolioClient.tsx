...
const t = {
  ...
  id: {
    ...
    heroTitle: "Software Engineer",
    heroSub: "Java · Spring Boot · Microservices",
    summary: "Software Engineer dengan 3+ tahun pengalaman membangun sistem backend di perbankan. Sehari-hari pakai Java dan Spring Boot, ngedesain microservices buat mobile banking, sistem pembayaran, dan open API. Suka kode yang bersih, senang problem solving, dan fokus bikin sesuatu yang beneran jalan.",
